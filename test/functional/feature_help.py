...
"""Verify that starting pettoken with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pettoken with -h for help text")
        ...
        self.log.info("Start pettoken with -version for version information")
