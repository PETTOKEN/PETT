...
const char * const BITCOIN_CONF_FILENAME = "pettoken.conf";
const char * const BITCOIN_PID_FILENAME = "pettokend.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "pettoken";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/pettoken";
#else
    // Unix
    return pathRet / ".pettoken";
#endif
#endif
}
