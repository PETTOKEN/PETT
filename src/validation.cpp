...
#if defined(NDEBUG)
# error "pettoken cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "pettoken Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PETT additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("pettoken-scriptch");
...
bool CChainState::ReplayBlocks(const CChainParams& params, CCoinsView* view)
{
    ...
    if (!hashHeads[1].IsNull()) { // The old tip is allowed to be 0, indicating it's the first flush.
        ...
        pindexFork = LastComPETTncestor(pindexOld, pindexNew);
