...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pettoken-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pettoken-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pettoken transaction") + "\n" +
              "  pettoken-tx [options] -create [commands]   " + _("Create hex-encoded pettoken transaction") + "\n" +
              "\n";
