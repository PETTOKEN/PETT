pettoken Core version *0.15.1* is now available from:
...
To receive security and update notifications, please subscribe to:
  ...
  <https://groups.google.com/forum/#!forum/pettoken-dev>
...
A number of changes to the way pettoken Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mPETT per kB (0.00001 PETT). This is to prepare for dropping the minimum transaction fee to 0.1 mPETT per kB (0.0001 PETT) in the next release.
