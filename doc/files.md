...
* pettoken.conf: contains configuration settings for pettokend or pettoken-qt
* pettokend.pid: stores the process id of pettokend while running
...
* debug.log: contains debug information and general logging generated by pettokend or pettoken-qt
